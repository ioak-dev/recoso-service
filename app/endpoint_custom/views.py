...
from app.endpoint_custom import service


@api_view(['GET'])
def get_endpoint_custom(request, space_id, project_id):
...
@api_view(['GET', 'PUT'])
def update_endpoint_custom(request, space_id):
    if request.method == 'GET':
...
@api_view(['DELETE'])
def delete_endpoint_custom(request, space_id, id):
